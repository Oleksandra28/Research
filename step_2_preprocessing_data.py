...
sandyData, sandyLabels = get_data_labels(filepath0, filepath1)
...
albertaData, albertaLabels = get_data_labels(filepath0, filepath1)
...
bostonData, bostonLabels = get_data_labels(filepath0, filepath1)
...
oklahomaData, oklahomaLabels = get_data_labels(filepath0, filepath1)
...
queenslandData, queenslandLabels = get_data_labels(filepath0, filepath1)
...
westtexasData, westtexasLabels = get_data_labels(filepath0, filepath1)
